 ...
 * elements + Tailwind tokens) and toast-free (errors render inline). On success
 * it lands the user in the new workspace, which resolves immediately via the
 * detail route's `getOrganizationBySlug` fallback while the JWT claims catch up.
 */
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-lg border bg-background p-6 shadow-lg">
            ...
            <p className="mt-1 text-muted-foreground text-sm">
              A workspace is where your projects and deployments live.
            </p>
