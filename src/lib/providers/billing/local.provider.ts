...
const UNLIMITED_ENTITLEMENTS: EntitlementsResponse = {
  ...
  entitlements: [
    createEntitlement("tier", "enterprise", "arbor"),
    createEntitlement("max_repositories", "unlimited", "arbor"),
    createEntitlement("max_collaborators", "unlimited", "arbor"),
    createEntitlement("max_private_repos", "unlimited", "arbor"),
    createEntitlement("max_members", "unlimited", "arbor"),
    createEntitlement("max_admins", "unlimited", "arbor"),
    createEntitlement("sso_enabled", "true", "arbor"),
    createEntitlement("audit_logs", "true", "arbor"),
  ],
};
