  ...
  const svg = await satori(
    {
      ...
      props: {
        ...
        children: [
          ...
          // Middle: owner/repo title + subtitle
          {
            type: "div",
            props: {
              style: {
              ...
              children: [
                ...
                },
                {
                  ...
                  props: {
                    ...
                    children: "Repository on Arbor",
                  },
                },
              ],
            },
          },
          // Bottom: Arbor logo + name + domain
          {
            type: "div",
            props: {
              style: {
...
export const Route = createFileRoute("/api/og/repo/$owner/$repo")({
  server: {
    handlers: {
      GET: async ({ params }) => {
        const { owner, repo } = params;

        const imageBuffer = await renderOgImage(owner, repo);
