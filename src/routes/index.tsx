...
function Home() {
  ...
  return (
    <>
      {/* Top nav, consistent with other Omni products (logo left, sign-in right) */}
      <header className="sticky top-0 z-50 w-full border-border/60 border-b bg-background/80 backdrop-blur-md">
        <div className="container mx-auto flex h-14 max-w-7xl items-center justify-between px-6">
          <Link to="/" className="flex items-center" aria-label="Arbor home">
            <LogoLockup
              logo={<img src="/logo.png" alt="" className="size-6 shrink-0" />}
              name="Arbor"
          ...
          <nav className="flex items-center gap-1 sm:gap-2">
            ...
            {isAuthenticated ? (
              <Button asChild>
                <Link to="/repositories">Open Arbor</Link>
              </Button>
            ) : (
        ...
        <section className="container mx-auto max-w-7xl px-6 pt-16 pb-20 md:grid md:grid-cols-2 md:items-center md:gap-10 md:pt-24 md:pb-28">
          <div className="arbor-fade-up flex flex-col justify-center space-y-6">
            ...
            <p className="max-w-150 text-lg text-muted-foreground md:text-xl">
              Arbor connects every repository, dependency, and team into a
              single living graph. Visualize relationships, host your code, and
              navigate your entire software architecture from one place.
            </p>
        ...
        <section className="container mx-auto max-w-7xl px-6 py-16">
          <div className="mx-auto mb-12 max-w-2xl text-center">
            ...
            <p className="mt-3 text-muted-foreground md:text-lg">
              Hosting, collaboration, and architecture insight that grow with
              your organization.
            </p>
          </div>
